...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="?r=site" class="logo">
            ...
            <span class="logo-lg"><b> E-PPID DISNAKERTRANS </b></span>
        </a>
            ...
            <?= dmstr\widgets\Menu::widget(
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'Profil Pegawai', 'icon' => 'user', 'url' => ['/profil']],
                        ['label' => 'Daftar berkas pengajuan', 'icon' => '', 'url' => ['/upload-berkas']],
                    ],
                ]
            ) ?>
            <!-- /.sidebar-menu -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2018 <a href="#">Kanwil DJKN RSK Pekanbaru</a>.</strong> All rights reserved.
    </footer>
